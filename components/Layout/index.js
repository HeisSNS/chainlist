    ...
    <div className="grid grid-cols-1 lg:grid-cols-[40vw,_auto]">
      <div className="relative h-full">
        <div className="p-5 sticky top-0 bottom-0 m-auto flex flex-col items-center gap-8 justify-center h-screen max-w-[480px] mx-auto">
          ...
          <div className="grid gap-3 w-full max-w-[16.25rem] mx-auto lg:mx-0">
            <a
              className="flex items-center justify-center gap-2 rounded-[50px] font-medium py-[17px] px-6 w-full bg-[#111827] text-white"
            ...
            <a
              className="flex items-center justify-center gap-2 rounded-[50px] font-medium py-[17px] px-6 w-full bg-[#627EEA] text-white"
